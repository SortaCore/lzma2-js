...
/// © 2020 Phi <info@dark-wire.com> | MIT
...
var LZMA = (function () {
    ...
    var /** cs */
        ...
        /** de */
        action_progress = 3,
        action_lzma2_compress = 4,
        action_lzma2_decompress = 5,
    ...
    function $init_0(this$static, input, output) {
        ...
        for (i = 0; i < (this$static.lzma2 ? 1 : 5); ++i) {
            r = $read(input);
            if (r == -1)
        ...
        decoder = $Decoder({lzma2 : this$static.lzma2});
        if (!$SetDecoderProperties(decoder, properties, this$static.lzma2)) {
        ...
        // Note: May be worth changing the size passed here to size of LZMA1 uncompressed chunk
    ...
    function $LZMA2_PropByteToLZMAProp(lzma2props) {
        var dicSizeByte = lzma2props[0];
        if (lzma2props[0] > 40)
            throw new Error("LZMA2 dictionary too big");
        // Second part is LZMA2_DIC_SIZE_FROM_PROP(dicSizeByte)
        var dicSize = lzma2props[0] == 40 ? 0xFFFFFFFF :
            ((2 | (dicSizeByte & 1)) << (dicSizeByte / 2 + 11));

        var props = [4 /* LZMA2_LCLP_MAX */,
            dicSize & 0xFF,
            (dicSize >> 8) & 0xFF,
            (dicSize >> 16) & 0xFF,
            (dicSize >> 24) & 0xFF];
    ...
    var LZMA_STATE = (function () {
        var LZMA_STATE = {};
        LZMA_STATE.CONTROL = 0;
        LZMA_STATE.UNPACK0 = 1;
        LZMA_STATE.UNPACK1 = 2;
        LZMA_STATE.PACK0 = 3;
        LZMA_STATE.PACK1 = 4;
        LZMA_STATE.PROP = 5;
        LZMA_STATE.DATA = 6;
        LZMA_STATE.DATA_CONT = 7;
        LZMA_STATE.FINISHED = 8;
        LZMA_STATE.ERROR = 9;
        return LZMA_STATE;
    }());
    ...
    function $CopyBlock(this$static, distance, len) {
        //console.log("copyblock of rep0 " + distance + ", and len " + len + ".");
    ...
    function $PutByte(this$static, b) {
        var unsignedB = b & 0xFF;
        this$static._buffer[this$static._pos++] = b;
        // PHI WHEN DOING COMPRESSING
        /*
        if (window.expOutput[(this$static._stream.count ? this$static._stream.count : 0) + this$static._pos - 1] != b) {
            console.log("PutByte: Incorrect byte at position " + (this$static._pos - 1) + ", exp " + window.expOutput[this$static._pos - 1] + ", act " + b);
            debugger;
        }*/
    ...
    function phi_literaldecoder_reset(this$static /* m_LiteralDecoder */) {
        // literal decoder may be tied to $Create_0() and $Init_0()
        for (var i = 0; i < this$static.m_Coders.length; ++i) {
            // calls LiteralSubdecoder::reset, which inherits LiteralSubcoder::reset(),
            // which effectively sets all propbs to 1024, e.g. calls
    ...
    function phi_lz_reset(this$static /* LZDecoder */) {
        ...
        //this$static.full = 0;
        //this$static.limit = 0;
        // this$static.buf[this$static.bufSize - 1] = 0x00;
    ...
    function phi_lzma_reset(this$static /* LZMADecoder; bytearrayinputstream? */) {
        ...
        phi_lzmacoder_reset(this$static);
        // literalDecoder.reset();
        // $Create_0(), $Init_0()
        phi_literaldecoder_reset(this$static.m_LiteralDecoder);

        // m_LenDecoder, m_RepLenDecoder.
    ...
    function lzma2_readUnsignedShort(this$static) {
        var buf = [0, 0];
        if ($read_0(this$static, buf, 0, 2) < 2) {
            throw new Error("Not big enough");
        }
        // TODO: Is this correct endian?
        var unsignedShort = ((buf[0] & 0xFF) << 8) | (buf[1] & 0xFF);
        return unsignedShort;
    }
    function lzma2_decodeChunkHeader(this$static) {
        // Read control byte
        var control = $read(this$static.decoder.m_RangeDecoder.Stream); // readUnsignedByte
        // reads as signed int, convert it to unsigned
        control = control & 0xFF;

        // control 0 = end of LZMA2 stream
        if (control == 0x00) {
            this$static.endReached = true;
            //lzma2_putArraysToCache(this$static);
            return;
        }

        // control >= 0xE0; LZMA chunk with some stuff to reset
        if (control >= 0xE0 || control == 0x01) {
            this$static.needProps = true;
            this$static.needDictReset = false;
            
            // this$static.lz.reset();
            phi_lz_reset(this$static.decoder);
            // fall through
        } else if (this$static.needDictReset) {
            throw new Error("CorruptedInputException");
        }

        // LZMA chunk
        if (control >= 0x80) {
            this$static.isLZMAChunk = true;

            this$static.uncompressedSize = (control & 0x1F) << 16;
            this$static.uncompressedSize += lzma2_readUnsignedShort(this$static.decoder.m_RangeDecoder.Stream) + 1;

            this$static.compressedSize = lzma2_readUnsignedShort(this$static.decoder.m_RangeDecoder.Stream) + 1;

            if (control >= 0xC0) {
                this$static.needProps = false;

                // Decode props:
                // decodeProps(this$static);
                var val, lc, remainder, lp, pb;

                // If LZMA2, decoder properties will keep changing; but dictionary size
                // remains constant. Checking if dictSize is 0 or undefined allows a single-run.
                if (((val = $read(this$static.decoder.m_RangeDecoder.Stream)) < 0) || (val > (4 * 5 + 4) * 9 + 8)) {
                    throw new Error("CorruptedInputException");
                }
                val = val & 255;
                lc = val % 9;
                ...
                if (this$static.lzma2 && this$static.decoder.m_DictionarySize > 0 &&
                    // SetLcLpPb, if failed...
                    $SetLcLpPb(this$static.decoder, lc, lp, pb) == 0) {
                    return -1;
                }
            } else if (this$static.needProps) {
                throw new Error("CorruptedInputException");
            } else if (control >= 0xA0) {
                phi_lzma_reset(this$static.decoder);
            }
    ...
    function phi_cleanupDecoder(this$static) {
    ...
    function $processDecoderChunk(this$static) {
        if (this$static.lzma2) {
            if (this$static.decoderChunkIndex == null)
                this$static.decoderChunkIndex = 0;
            this$static.decoderChunkIndex++;
            lzma2_decodeChunkHeader(this$static);
            if (this$static.endReached) {
                phi_cleanupDecoder(this$static);
                return;
            }

            // 1:1 block to copy
            if (!this$static.isLZMAChunk) {
                for (var inPos = this$static.decoder.m_RangeDecoder.Stream.pos, maxInPos = inPos + this$static.uncompressedSize; inPos < maxInPos; ++inPos) {
                    $PutByte(this$static.decoder.m_OutWindow, this$static.decoder.m_RangeDecoder.Stream.buf[inPos]);
                }
                //$CopyBlock(this$static.decoder.m_OutWindow, 0 /* was rep0 */, this$static.uncompressedSize);
                // nowPos64 is OUTPUT stream position.
                this$static.decoder.nowPos64 = add(this$static.decoder.nowPos64, fromInt(this$static.uncompressedSize));
        ...
        for (var i = 0; ; i++) {
            ...
            // note inBytesProcessed is only used by encoder
        ...
        else if (result || compare(this$static.decoder.outSize, P0_longLit) >= 0 && compare(this$static.decoder.nowPos64, this$static.decoder.outSize) >= 0) {
            phi_cleanupDecoder(this$static);
        }
    ...
    function $Decoder(this$static) {
        ...
        // was initDim(114), calcd it from distSpecials
        this$static.m_PosDecoders = initDim(124);
    ...
    function $Init_1(this$static) {
        ...
        $Init(this$static.m_RepLenDecoder);
        InitBitModels(this$static.m_PosAlignDecoder.Models);
        this$static.m_RangeDecoder.lzma2 = this$static.lzma2;
        $Init_8(this$static.m_RangeDecoder);
    }

    function $SetDecoderProperties(this$static, properties, is_lzma2) {
        var dictionarySize, i, lc, lp, pb, remainder, val;
        if (properties.length < (is_lzma2 ? 1 : 5))
            return 0;
        val = properties[0] & 255;
        // lzma2 properties: a single byte dict size, LC/LP/etc all based on preset
        if (is_lzma2) {
            // LzmaEnc.c, line 70; from LZMA2_LCLP_MAX
            lc = 3;
            lp = 0;
            pb = 2;
            dictionarySize = 0;
            if (val == 40) {
                ...
                dictionarySize = ((2 | ((val) & 1)) << ((val) / 2 + 11));
                // LZMA2_DIC_SIZE_FROM_PROP(prop);
            }
            this$static.bufSize = this$static.dictionarySize;
            this$static.buf = initDim(this$static.bufSize);
        }
        else {
            lc = val % 9;
            remainder = ~~(val / 9);
    ...
    function $DecodeNormal(this$static, rangeDecoder) {
        ...
        var arr = [];
        do {
            var d = $DecodeBit(rangeDecoder, this$static.m_Decoders, symbol);
            arr.push(d);
            symbol = symbol << 1 | d;
        } while (symbol < 256);
        return symbol << 24 >> 24;
    ...
    function phi_readInt(this$static) {
        var buf = [0, 0, 0, 0];
        if ($read_0(this$static, buf, 0, 4) != 4) {
            throw "not big enough";
        }
        // this is correct endian
        var num = ((buf[0] & 0xFF) << 24) | ((buf[1] & 0xFF) << 16) | ((buf[2] & 0xFF) << 8) | (buf[3] & 0xFF);
        return num;
    }
    var INIT_SIZE = 5;

    function phi_setCode(this$static, code) {
        //console.log("code set to " + code);
        this$static.Code = code;
    }
    function phi_setRange(this$static, range) {
        //console.log("range set to " + range);
        this$static.Range = range;
    }
    function phi_prepareInputBuffer(this$static /* rc, rangeDecoder */, len) {
        ...
        phi_setRange(this$static, -1); // 0xFFFFFFFF);
        ...
        //this$static.len -= INIT_SIZE;
        // this$static.Stream.count -= INIT_SIZE;
        //this$static.Stream.pos = this$static.Stream.buf.length - len;
    }
    ...
    function $DecodeBit(this$static, probs, index) {
        ...
        var origCode = this$static.Code;
        var origPos = this$static.Stream.pos;

        if ((this$static.Code ^ -2147483648) < (newBound ^ -2147483648)) {
            phi_setRange(this$static, newBound);
            //this$static.Range = newBound;
            probs[index] = prob + (2048 - prob >>> 5) << 16 >> 16;
            if (!(this$static.Range & -16777216)) {
                //this$static.Code = this$static.Code << 8 | $read(this$static.Stream);
                //this$static.Range <<= 8;
                phi_setCode(this$static, this$static.Code << 8 | $read(this$static.Stream));
                phi_setRange(this$static, this$static.Range << 8);
            }
            return 0;
        } else {
            //this$static.Range -= newBound;
            //this$static.Code -= newBound;
            phi_setRange(this$static, this$static.Range - newBound);
            phi_setCode(this$static, this$static.Code - newBound);
    ...
    function $DecodeDirectBits(this$static, numTotalBits) {
        ...
        for (i = numTotalBits; i != 0; --i) {
            phi_setRange(this$static, this$static.Range >>> 1);
            // this$static.Range >>>= 1;
            t = this$static.Code - this$static.Range >>> 31;
            phi_setCode(this$static, this$static.Code - (this$static.Range & t - 1));
    ...
    function $Init_8(this$static) {
        //this$static.Code = 0;
        //this$static.Range = -1;
        phi_setCode(this$static, 0);
        phi_setRange(this$static, -1);
    ...
    function lzma2_decompress(byte_arr, on_finish, on_progress) {
        var this$static = {},
            percent,
            cbn, /// A callback number should be supplied instead of on_finish() if we are using Web Workers.
            has_progress,
        ...
        on_finish = on_finish || function (res, err) {
            ...
            return postMessage({
                action: action_lzma2_decompress,
                cbn: cbn,
                result: res,
                error: err
            });
        };
        this$static.lzma2 = true;

        if (sync) {
            this$static.d = $LZMAByteArrayDecompressor({lzma2 : true}, byte_arr);
    ...
    function lzma2_compress(byte_arr, on_finish, on_progress) {
        byte_arr[0] = 0;
        on_finish();
        on_progress();
        return;
        ...
        (function () {
            ...
            onmessage = function (e) {
                if (e && e.data) {
                    ...
                    } else if (e.data.action == action_lzma2_decompress) {
                        LZMA.lzma2_decompress(e.data.data, e.data.cbn);
                    } else if (e.data.action == action_lzma2_compress) {
                        LZMA.lzma2_compress(e.data.data, e.data.mode, e.data.cbn);
                    }
                    /** xe */
    ...
    return {
        ...
        lzma2_compress: lzma2_compress,
        lzma2_decompress: lzma2_decompress,
        /** xe */
